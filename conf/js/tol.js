...
$('[id^=d_vtor_a_]').change(function() {
    if (this.id.indexOf('nt') == -1) {
        if (this.selectedIndex > 0) { $('#' + this.id + '_nt').prop('disabled', false); } else { $('#' + this.id + '_nt').prop('checked', false);
...
$('[id^=vtor_b_]').change(function() {
    if (this.id.indexOf('nt') == -1) {
        ...
        b_1 = 5;
        b_2 = 35;
        if ((b_ == '0.2S' || b_ == '0.2' || b_ == '0.5S' || b_ == '0.5') && gab == 'IV-11') { b_1 = 5;
            b_2 = 20; }
        if (b_ == '5Р' || b_ == '10Р') { b_1 = 10;
            b_2 = 35; }
        if (this.selectedIndex > 0) { $('#' + this.id + '_nt').prop('disabled', false); } else { $('#' + this.id + '_nt').prop('checked', false);
            $('#' + this.id + '_nt').prop('disabled', true); }
        $.ajax({
...
$('#gab').change(function() {
    ...
    $.ajax({
        ...
        success: function(data2) {
            ...
            $.ajax({
                type: "POST",
                url: "/intzv/wp-content/themes/UnderStrap-ntzv-1/conf/res2rad.php",
...
function addrow(t) {
    ...
    if (obm.length < gab0 && vyvod < (gab00 - 1)) {
        ...
        if (rowinner1 == '') { rowinner = tab.rows[2].innerHTML;
            rowinner1 = tab.rows[2].innerHTML; } else { rowinner = rowinner1 };
...
function popup(classn, t) {
    ...
    if (classn != '') { dv.className = classn; } else { dv.className = 'info'; }
...
function search() {
    ...
    if ($("#sec_term_id_sec_term_3").is(':checked') && document.getElementById('gib_vv').value * 1 >= 1) { c += 'С';
        v = ' (выводы ' + document.getElementById('gib_vv').value + 'м)' }; //русская С
    if ($("#sec_term_id_sec_term_4").is(':checked') && document.getElementById('gib_vv').value * 1 >= 1) { c += 'D';
        v = ' (выводы ' + document.getElementById('gib_vv').value + 'м)' };
    if ($("#sec_term_id_sec_term_3").is(':checked') && document.getElementById('gib_vv').value * 1 < 1) { c += 'С';
        v = ' (выводы ' + document.getElementById('gib_vv').value * 1000 + 'мм)' }; //русская С
    if ($("#sec_term_id_sec_term_4").is(':checked') && document.getElementById('gib_vv').value * 1 < 1) { c += 'D';
        v = ' (выводы ' + document.getElementById('gib_vv').value * 1000 + 'мм)' };
...
function likesearch() {
    ...
    if ($("#sec_term_id_sec_term_3").is(':checked') && document.getElementById('gib_vv').value * 1 >= 1) { c += (!$('#var_v_v_nt').prop('checked')) ? ('С') : '%';
        v = (!$('#var_v_v_nt').prop('checked')) ? (' (выводы ' + document.getElementById('gib_vv').value + 'м)') : ' %' }; //русская С
    if ($("#sec_term_id_sec_term_4").is(':checked') && document.getElementById('gib_vv').value * 1 >= 1) { c += (!$('#var_v_v_nt').prop('checked')) ? ('D') : '%';
        v = (!$('#var_v_v_nt').prop('checked')) ? (' (выводы ' + document.getElementById('gib_vv').value + 'м)') : ' %' };
    if ($("#sec_term_id_sec_term_3").is(':checked') && document.getElementById('gib_vv').value * 1 < 1) { c += (!$('#var_v_v_nt').prop('checked')) ? ('С') : '%';
        v = (!$('#var_v_v_nt').prop('checked')) ? (' (выводы ' + document.getElementById('gib_vv').value * 1000 + 'мм)') : ' %' }; //русская С
    if ($("#sec_term_id_sec_term_4").is(':checked') && document.getElementById('gib_vv').value * 1 < 1) { c += (!$('#var_v_v_nt').prop('checked')) ? ('D') : '%';
